...
**Econometrics Note**: Heidelbergのコア計量を自分なりにまとめました, 記載がだいぶ前なこともあり, 不正確なところが多いのであまり信用しないように.

**Econometrics Sueishi**: 『計量経済学-ミクロデータ分析へのいざない』の不明点や行間を埋めるノートです. 誤差項の説明等は不正確です, DDRでは改善しているのでそちらを参照してください.
...
**計量特論_不明点補足**: 計量経済特論 B のスライドに関する不明点や行間を埋めるノートです.

**GameTheory_Tabeil**: Tabeil の Game Theory に関する不明点や行間を埋めるノートです. Ch 12 の内容までしか精査していません. Ch 15, 16 は AI 生成からあまり修正加え切れていないので参考にしないでください.

**中級マクロまとめ**: 一橋の中級マクロに関するまとめ資料です.

**上級マクロまとめ**: 一橋のコアマクロに関するまとめ資料です.

**上級マクロ補足**: 上級マクロのまとめ資料で議論した点に関する詳述や導出です.
...
**Semi Data Driven Regression**: 『ミクロ経済学の力』の勉強会紹介スライド.
...
2026/01/31 22:39 勉強会スケジュール, 更新しました.
