...
この時, TSLSのバイアスは$Corr(z, x)$で大幅に増幅される. 実際この値が$.10$のオーダーに乗らないことすらしばしばである.\\
...
つまり, 価格を$1$パーセント上げると消費が$1.08$パーセント減少する. 果たしてこれは有効な結果だろうか?　\rmfamily\mcfamily\bfseries{解答}\mdseries　一段階目の$t$値は約$6$でおおよその水準で統計的有意. 二段階目にも有意性を認められるため, 有効であると見てよさそうだ.\\
