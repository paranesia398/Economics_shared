...
(AP1)は強い外生性を意味しており, FE推定量が不偏性を持つことを保証している. 実際, この仮定から$Cov(\epsilon_{i,t}, x_{i,\tau,1}) = 0, \forall\tau\in\{1,\dots,T\}$も確認できる. (AP2)は誤差項の\rmfamily\mcfamily\bfseries{均一分散性}\mdseries と, \rmfamily\mcfamily\bfseries{系列相関がない}\mdseries こと, この二つを保証する. この仮定が崩れた場合にはこの二つが崩れうることに注意しよう. (AP1)\sim(AP4)の下で, $b_1^{FE}$の漸近分布は以下のように与えられる.
