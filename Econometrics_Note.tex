...
\section{制約とF検定}
制約が他の制約にもなる, つまり入れ子構造になっていて, かつモデルをより特定化するものを考える. \\
